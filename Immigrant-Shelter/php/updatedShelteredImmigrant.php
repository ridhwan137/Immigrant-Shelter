            ...
            <div class="col py-3" style="">
                <table class="table table-dark table-hover" style="text-align:center">
                    ...
                    <tbody>
                        ...
                        // Query
                        $query = "SELECT * FROM immigrant WHERE `accountStatus` = 'accept' ORDER BY `dateApply` ASC";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <!-- <td>13/12/13</td> -->
                                    <td>
                                        <button type="button" class="btn btn-primary" onclick="window.location.href='viewShelterImmigrant.php?id=<?=$id?>'">View</button>
                                        <button type="button" class="btn btn-danger" onclick="window.location.href='sql/deleteImmigrantAccount.php?delete_id=<?=$id?>'">Delete</button>
                                    </td>
                                </tr>
                        <?php
                            }
