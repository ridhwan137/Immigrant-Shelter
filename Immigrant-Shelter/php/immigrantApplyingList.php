    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                ...
                <?php
                // Query
                $query = "SELECT * FROM immigrant WHERE `accountStatus` = 'pending'";
                ...
                ?>
                        <div class="card">
                            <div class="card-body position-center">
                                ...
                                <p>Name: <?= $name ?> </p>
                                <p>Vaccine Status: <?= $vaccination_status ?></p>
                                <p>Reason: <?= $reason ?></p>
                                <p>
                                    <!-- Pass id by url -->
                                    <button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='immigrantApplyingListMoreDetail.php?id=<?=$id?>'">More Detail</button>
                                </p>
                            </div>
                        </div>
                <?php
